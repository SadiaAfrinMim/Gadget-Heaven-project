...
const CardDetails = () => {
  ...
  return (
    <div className="flex justify-center items-center w-11/12 mx-auto  relative">
      {singleDetails ? (
        <div className="bg-white p-6 rounded-lg shadow-lg lg:flex gap-8 justify-center items-center -mt-36">
          ...
          <div className="flex-1 space-y-2">
            ...
            <div className="flex gap-2">
              ...
              <Link to={"/dashboard/wishlist"}>
                <button onClick={()=>handleWishList(product_id)} className="btn text-white bg-[#9538E2] rounded-full font-bold">
                  Wishlist
                </button>
              </Link>
            </div>
